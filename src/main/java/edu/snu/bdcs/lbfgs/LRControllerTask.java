...
public class LRControllerTask implements Task {
    ...
    public byte[] call(byte[] memento) throws Exception {
        // Scatter the data into compute nodes
        logger.log(Level.FINE, "Scattering the Data");
        scatterSender.send(X);
        logger.log(Level.FINE, "Finished Scattering the Data");
